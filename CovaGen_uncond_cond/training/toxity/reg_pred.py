...
with open('/workspace/datas/try_add_100_2.txt','r') as f:
    zero_list  = [i.rstrip() for i in f.readlines()]
with open('/workspace/datas/ours_100.txt','r') as f:
...
sns.kdeplot(y_pred_loaded, label = "LDDD-tox",shade=True)
sns.kdeplot(y_pred_loaded_zero, label="LDDD", shade=True)
